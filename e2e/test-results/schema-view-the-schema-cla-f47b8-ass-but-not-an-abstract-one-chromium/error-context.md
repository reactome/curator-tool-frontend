...
- Name: schema-view.spec.ts >> the schema class tree >> offers a create button on a concrete class but not an abstract one
- Location: tests/schema-view.spec.ts:42:7
...
Locator: locator('mat-tree-node').filter({ hasText: /\bPathway\b/ }).first().getByRole('button')
Expected: visible
Error: strict mode violation: locator('mat-tree-node').filter({ hasText: /\bPathway\b/ }).first().getByRole('button') resolved to 2 elements:
    1) <button disabled="true" mat-icon-button="" ng-reflect-disabled="" _ngcontent-ng-c1926907790="" mat-ripple-loader-centered="" mat-ripple-loader-disabled="" mat-ripple-loader-uninitialized="" mat-ripple-loader-class-name="mat-mdc-button-ripple" class="mdc-icon-button mat-mdc-icon-button mat-mdc-button-disabled mat-unthemed mat-mdc-button-base">…</button> aka getByRole('button').nth(2)
    2) <button mattooltipposition="right" ng-reflect-position="right" ng-reflect-show-delay="500" cdk-describedby-host="ng-1" _ngcontent-ng-c1926907790="" class="mat-mdc-tooltip-trigger mat-icon-button" ng-reflect-message="Click to create new Pathway" aria-describedby="cdk-describedby-message-ng-1-21">…</button> aka getByRole('button', { description: 'Click to create new Pathway', exact: true })

Call log:
  - Expect "toBeVisible" locator('mat-tree-node').filter({ hasText: /\bPathway\b/ }).first().getByRole('button') with timeout 10000ms
  - waiting for locator('mat-tree-node').filter({ hasText: /\bPathway\b/ }).first().getByRole('button')
...
- generic [ref=e2]:
  ...
  - generic:
    - button "Toggle help panel" [ref=e219] [cursor=pointer]:
      - img [aria-hidden] [ref=e220]: help_outline
    - generic [ref=e223]:
      - generic [ref=e224]:
        - img [aria-hidden] [ref=e225]: help_outline
        - generic [ref=e226]: Schema View Help
        - button "Close help" [ref=e227] [cursor=pointer]:
          - img [aria-hidden] [ref=e228]: close
      - generic [ref=e231]:
        - heading "Class Tree (left)" [level=4] [ref=e232]
        - list [ref=e233]:
          - listitem [ref=e234]: Click a class name to view its attribute definitions.
          - listitem [ref=e235]: Click the [count] badge to list instances from the database.
          - listitem [ref=e236]: Click the (count) badge to list staged/local instances only.
          - listitem [ref=e237]: Click the + icon to create a new instance of that class.
        - heading "Instance List" [level=4] [ref=e238]
        - list [ref=e239]:
          - listitem [ref=e240]: Type in the search box and press Enter for a quick search.
          - listitem [ref=e241]: Click the filter icon to switch to Advanced Search.
          - listitem [ref=e242]: "Select rows to enable bulk actions: Delete Selected, Batch Edit, Compare."
          - listitem [ref=e243]: Click the Download icon (after a search) to export results as CSV.
          - listitem [ref=e244]: Use pagination controls at the bottom to navigate large lists.
        - heading "Instance Editor" [level=4] [ref=e245]
        - list [ref=e246]:
          - listitem [ref=e247]: Click any row to open the instance in the editor.
          - listitem [ref=e248]: Edit text fields directly — press Enter to commit, Ctrl+Enter for a new line.
          - listitem [ref=e249]: Use the action menu on instance-type slots to set, add, replace, or delete values.
          - listitem [ref=e250]: Drag a bookmark onto a compatible slot to set its value.
          - listitem [ref=e251]: Click the QA icon to run quality checks on the instance.
          - listitem [ref=e252]: Click the Upload icon to commit only this instance.
        - heading "Batch Edit" [level=4] [ref=e253]
        - list [ref=e254]:
          - listitem [ref=e255]: Click the Batch Edit icon in the search bar to open the dialog.
          - listitem [ref=e256]: Select an attribute and an action (Add, Replace, Delete) to apply across instances.
          - listitem [ref=e257]: If rows are selected, batch edit targets only those; otherwise it applies to the full list scope.
        - separator [ref=e258]
        - link "Open full Tutorial page" [ref=e259] [cursor=pointer]:
          - /url: /tutorial
          - img [aria-hidden] [ref=e260]: school
