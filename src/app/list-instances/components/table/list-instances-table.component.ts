...
// handleError @ /Users/wug/git/reactome/curator-tool-frontend/node_modules/@angular/core/fesm2020/core.mjs:8400:23
  loadInstances() {
    // Make sure getInstanceCount first and then listInstance so that there is no reset of paginator.length.
    this.dataService.getInstanceCount(this.className, this.searchKey).subscribe(count => {
